import { Home, History, FileBarChart, Settings, LayoutDashboard, ChevronDown, Plus, Users, Package, Briefcase } from 'lucide-react';
...
export function DesktopSidebar() {
  const { currentBusiness, businesses, switchBusiness, createBusiness, userRole } = useBusiness();
  ...
  const allNavItems = [
    ...
    { icon: Briefcase, label: 'Staff', to: '/staff', adminOnly: true },
    { icon: History, label: 'Transactions', to: '/history' },
    { icon: FileBarChart, label: 'Reports', to: '/reports', adminOnly: true },
